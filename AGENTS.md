...
- Retrofit sweep (ADR-0016): an explicit "run the sweep" request, once, over
  the whole vault — never scheduled, the same machinery as consolidation/
  promotion above run in bulk plus a new merge pass. Refuses immediately, no
