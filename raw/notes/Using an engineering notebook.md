...
And I (usually) don't show them to anyone else, ever. They're entirely for my work. The writing is the work, in a lot of ways, since it's the thinking.

Since enough people asked, as a one-time thing, I took a picture from the engineering I notebook I use for my side project work and shared it on Mastodon, and here's a photo of a full page from that side project work.


A heads up: posting photos uses up a lot of my bandwidth, and it isn't free! If you want to help me afford this post getting a lot of traffic, consider joining my Patreon.
...
And if you do use one, try changing it up! Experiment[2] with the format and the medium. Experiment with the level of detail. Then share what you learn with everyone else, so we can get ideas from your experiments, too!

It's physical, but eink, for a lot of reasons. Principal among them are that I'm left-handed and prefer my hand to not be smeared with graphite or ink all the time, and that carrying around a lot of notebooks got unwieldy. ↩

If you are really dedicated to this, you could use a lab notebook to record your experiments about lab notebooks, and then you'd end up with notebooks all the way down. ↩