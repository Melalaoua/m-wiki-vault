...
- **Purpose: Développer un outil d’aide au diagnostic (OAD) basé sur une approche syndromique.
...
- App is coded in react native on android tablet.
- Full platform functionality accessible from a tablet device without internet.
...
- Integrates [PostHog](https://posthog.com/demo) to the app for monitoring/deployment purposes
