...
C'est surement l'une des techniques les plus avancées pour le prompt engineering. Proposée par [Wang et al. (2022)](https://arxiv.org/abs/2203.11171), self-consistency vise à remplacer la manière cupide du [[Chain-of-Thought Prompting]].

L'idée est la suivante : échantillonner plusieurs raisonnement diversifiés via un [[Chain-of-Thought Prompting|Few-shot CoT]] et utiliser les résultats les plus consistants. Ceci aide à booster les performance du CoT sur des tâches impliquant de l'arithmétique, ou du sens-commun.
...
Faux. Comment améliorer ça via du self-consistency ? Essayons la chose suivante. On donne plusieurs exemples en [[Few-shot Prompting]] tirés de Wang et al 2022 (table 17)
