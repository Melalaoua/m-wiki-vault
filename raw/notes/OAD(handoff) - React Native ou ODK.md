...
Les données peuvent être collectées en ligne ou offline, tout est synchronisés lorsqu'une connection est retrouvée.
...
- Souma ; project manager.
- Romaric ; un point 0 dans le projet/ responsable
