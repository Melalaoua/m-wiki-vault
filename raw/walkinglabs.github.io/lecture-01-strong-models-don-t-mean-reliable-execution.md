...
## Same Horse, Different Fates [​](#same-horse-different-fates)
...
## Where Agents Actually Get Stuck [​](#where-agents-actually-get-stuck)
...
## When Things Fail, Fix the Harness First [​](#when-things-fail-fix-the-harness-first)
...
## The Million-Line Experiment [​](#the-million-line-experiment)
...
## A More Down-to-Earth Example [​](#a-more-down-to-earth-example)
