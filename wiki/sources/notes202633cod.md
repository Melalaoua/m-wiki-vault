...
- The Cult of Done manifesto was written in a 20-minute timebox by Bre Pettis and Kio Stark. ([[raw/notes/33-COD#The Cult Of $DONE$]]) — "This was written in collaboration with Kio Stark in 20 minutes because we only had 20 minutes to get it done."
- Finished projects are meant to act as a catalyst for future work, not as an end in themselves. ([[raw/notes/33-COD#The point of Being $DONE$ is not to Finish]]) — "The point of being done is not to finish but to get other things done."
- Sharing unexecuted ideas publicly serves as a valid form of project completion. ([[raw/notes/33-COD#If You Have an Idea and Publish it on the Internet]]) — "If you have an idea and publish it on the internet, that counts as a ghost of done."
