...
extensive experimentation, making reinforcement learning broadly applicable.0
300
600
900
PPO
...
> **Figure 1:** A small 3D rendered cube with a brown/tan textured surface, appearing to be a pixelated or blocky style cube resembling a Minecraft-style block. The cube is shown in isometric perspective with shading that gives it depth and dimension.

> **Figure 2:** A 3D rendered image of a cubic block with a textured, brownish-tan surface that appears to have a weathered or sandy material. The cube is shown in isometric perspective with shading that gives it depth and dimension. The surface has a slightly rough, granular texture typical of stone, sand, or concrete.

> **Figure 3:** The image shows a small, dark brown elongated object that appears to be a stick, twig, or similar linear item against a light background. The object has a slightly curved shape and tapers slightly toward one end.

> **Figure 4:** A 3D isometric illustration of a brown and tan cubic structure or block, rendered in a pixel art or voxel style. The cube appears to be made up of smaller cubic units with varying shades of brown, creating a textured, blocky appearance. The image shows the cube from an angled perspective, allowing visibility of three faces of the cube.

> **Figure 5:** A small pixelated icon showing a pickaxe or mining tool, rendered in a retro 8-bit or pixel art style with brown and tan colors. The tool appears to be tilted at an angle, typical of vintage video game graphics.

> **Figure 6:** The image shows a 3D rendered cube with a dark gray textured surface. The cube appears to be a procedurally generated or noise-based texture, giving it an organic, rocky or stone-like appearance. The cube is shown at an isometric angle against a light gray background.

> **Figure 7:** The image shows a small pixelated or 8-bit style icon of a pickaxe or mining tool. It appears to be a simple black and brown colored pixel art graphic, likely from a video game or retro digital interface. The tool is depicted at an angle, pointing downward and to the right.

> **Figure 8:** A small 3D rendered cube or isometric box with a dark gray textured surface and subtle shading to show depth and dimensionality. The cube appears to be a simple geometric shape used as an icon or illustration element.

> **Figure 9:** The image shows a 3D rendered cube or voxel structure with a gray textured surface. It appears to be a simple geometric object rendered with shading to show depth and dimension. The cube has a slightly weathered or stone-like texture on its visible faces.

> **Figure 10:** The image shows a simple 3D isometric illustration of a rectangular box or container with a gray color scheme. It appears to be a basic geometric shape rendered in a minimalist style, possibly representing a package, storage container, or similar object.

> **Figure 11:** A simple icon showing a wrench tool drawn in a minimalist style with a brown/tan color. The wrench is depicted at an angle, with the handle on the left side and the adjustable head on the right side.

> **Figure 12:** The image shows a small pixel art icon of a cyan/turquoise colored hexagonal or gem-like shape with darker cyan outlines, resembling a video game sprite or retro computer graphics style icon.
...
> **Figure 1:** A 3x3 grid of 3D rendered images showing various stick figure poses and gestures against a blue checkered floor background with a starry sky. The figures are rendered in orange/tan color and display different body positions including standing, crouching, bending, and arm gestures. Some panels show simplified stick figure representations with dots indicating joint positions or motion points.

> **Figure 2:** A grid of 9 classic 8-bit and early arcade video game screenshots arranged in a 3x3 layout. The games shown include Galaga (top middle), Space Invaders (top right), what appears to be Defender or similar shooting games, Jungle Hunt or similar platformer (middle left), a dungeon-style game (middle center), a blue character game (middle right), a pyramid-stacking game (bottom left), a sky-diving or cloud game (bottom middle), and a Space Invaders-style shooter (bottom right). The image showcases the visual style of classic arcade and early home computer games from the 1980s era.

> **Figure 3:** A collage of classic video game screenshots showing various retro games from different eras. The collection includes a red brick structure with gray platforms (possibly Donkey Kong), a space-themed game with a spherical planet and dotted trajectory lines, a green maze-like level with paths and collectibles, an underwater or ocean-themed scene with blue waves, a scene with what appears to be a spaceship and atmospheric effects, and various other pixelated game environments. The games appear to be from the 1980s-1990s arcade and home console era.

> **Figure 4:** A grid of 9 screenshots from a first-person video game showing various indoor and outdoor environments with colorful blocky architecture, including yellow and blue tiled rooms, red furniture, water areas, and desert landscapes. Each screenshot displays a numbered counter in the corner (118, 121, 100, 124, 116, 20, and 110 visible), suggesting these are different game levels or scenes.

> **Figure 5:** A grid of 12 Minecraft game screenshots showing various landscape scenes. The images depict different biomes and environments including grassy plains, water bodies, rocky terrain, forests, and mountainous areas. Each screenshot captures different perspectives and locations within the Minecraft world, showcasing the game's blocky aesthetic and varied terrain generation.
...
h2
h1
enc encenc dec dec dec(a) World Model Learningh3
h2
h1
a1 a2
v1 v2
...
> **Figure 1:** A heavily pixelated and blurry image showing what appears to be a figure or object against a dark green background. The image quality is very low, making it difficult to discern specific details. There are some lighter colored areas in the upper portion and what might be reddish or orange coloring in the lower right section of the image.

> **Figure 2:** A pixelated, blocky scene from a Minecraft-style game showing a small wooden structure or house with a white door beneath a large green tree canopy. The scene features a grassy landscape with a blue sky, rendered in characteristic low-resolution cubic blocks typical of voxel-based games.

> **Figure 3:** A blurry image showing what appears to be an outdoor scene with green grass or vegetation in the foreground and background. There are some indistinct objects or structures visible, but the image quality is poor with significant pixelation and lack of focus, making it difficult to discern specific details.

> **Figure 4:** A low-resolution, pixelated image showing what appears to be a close-up view of green organic material or foliage with some lighter colored areas (possibly sky or light reflection) visible at the top. The image quality is very poor with significant pixelation and noise, making it difficult to discern specific details.

> **Figure 5:** A pixelated Minecraft-style landscape showing a grassy field with trees. The image features green grass blocks in the foreground, dark green foliage from tree canopies above, brown tree trunks, and a blue sky with white clouds in the background. The scene appears to be a natural outdoor environment in a blocky, voxel-based graphics style typical of Minecraft.

> **Figure 6:** A pixelated Minecraft-style image showing a first-person view of a hand holding what appears to be a pink/salmon colored object or tool in the foreground. In the background, there are white blocky shapes (possibly sheep or clouds), brown ground blocks, and green foliage/leaves overhead, creating a typical Minecraft landscape scene.

> **Figure 7:** A simple icon illustration showing a joystick or game controller. It features a dark gray/charcoal rectangular base with a red accent on the left side, and a vertical gray stem rising from the center topped with a large red circular ball or knob at the top. The design is minimalist and stylized, typical of user interface icons.

> **Figure 8:** A simple icon showing a joystick or game controller with a red circular button on top, a gray stem, and a dark gray/black base platform. The design is minimalist and uses a limited color palette of red, gray, and black.

> **Figure 9:** A simple diagram showing a vertical bracket or matrix notation containing two variables. At the top is 'q1' and at the bottom is 'qN', with three dots in between indicating continuation of elements. This appears to be a mathematical representation of a vector or column matrix with N elements.

> **Figure 10:** The image shows a vertical bracket or matrix notation containing a column vector. It displays the mathematical symbol 'q' with subscripts, showing q₁ at the top, three dots in the middle indicating omitted elements, and qₙ at the bottom, representing a vector with N elements.

> **Figure 11:** A mathematical notation showing a column vector with q1 at the top, three dots in the middle indicating continuation, and qN at the bottom, all enclosed in square brackets.

> **Figure 12:** The image shows a mathematical notation representing a column vector or matrix with N rows. It displays the first element labeled as q₁, followed by three vertically arranged dots indicating continuation, and the last element labeled as qₙ. The entire expression is enclosed in square brackets on both sides, which is standard mathematical notation for matrices or vectors.

> **Figure 13:** The image shows a mathematical notation representing a column vector or matrix with N elements. It displays the first element labeled as 'q1' at the top, three dots in the middle indicating continuation of elements, and the last element labeled as 'qN' at the bottom, all enclosed in square brackets on both sides.

> **Figure 14:** The image shows a vertical vector notation with square brackets on the left and right sides. It contains the label 'q1' at the top and 'qN' at the bottom, with three dots in the middle representing omitted elements. This is a standard mathematical representation of a column vector or matrix in linear algebra.

> **Figure 15:** A first-person perspective screenshot from Minecraft showing a player's hand holding a pink/salmon colored item in the foreground. The scene depicts a grassy landscape with trees, including a prominent dark tree trunk overhead and foliage above. There are white sheep visible in the middle distance on the green grass plains. The sky is visible in the background with a blue color. This appears to be a typical Minecraft survival or creative mode gameplay scene.

> **Figure 16:** A simple icon illustration showing a joystick or game controller with a red circular knob on top and a dark gray/black base. The design is minimalist and uses a limited color palette of red, gray, and black.

> **Figure 17:** A simple icon showing a red joystick or game controller with a red ball/knob on top mounted on a dark gray/black base. The design is minimalist and appears to be a user interface icon representing gaming or control functionality.

> **Figure 18:** A mathematical notation showing a column vector with N elements. The vector is represented with square brackets on the left and right, containing the elements q₁ at the top, three dots in the middle indicating continuation, and qₙ at the bottom, representing a general vector of dimension N.
...
T = 0
Model
5 10 15 20 25 30 35 40 45 50True
Context Input Open Loop Prediction
T = 0
Model
5 10 15 20 25 30 35 40 45 50Figure 4: Multi-step video predictions of a DMLab maze (top) and a quadrupedal robot (bottom).
...
Encoder: zt ∼ qϕ(zt | ht, xt)
Dynamics predictor: ˆzt ∼ pϕ(ˆzt | ht)
Reward predictor: ˆrt ∼ pϕ(ˆrt | ht, zt)
Continue predictor: ˆct ∼ pϕ(ˆct | ht, zt)
...
> **Figure 1:** A pixelated/retro-style 3D video game scene showing a water environment with orange/terracotta colored buildings or structures on either side, green pillars or columns, a blue water surface in the foreground, and a clear blue sky background. The graphics appear to be in a voxel or Minecraft-like style.

> **Figure 2:** A pixelated, low-resolution 3D rendered scene showing an isometric or perspective view of blocky structures and terrain. The image features colored blocks including orange/red walls or structures, a green vertical plane or wall, blue sky and water elements, yellow/golden ground or sand area, and gray architectural elements. The style is reminiscent of voxel-based graphics or early 3D game engine rendering.

> **Figure 3:** A pixelated top-down view of what appears to be a game map or dungeon layout. The image shows a green tiled floor with dark walls creating various corridors and rooms. There are several UI elements visible at the bottom including what looks like an inventory bar with colored squares (brown, gray, cyan, and blue items). The left side has a blue vertical element, possibly a menu or sidebar. This appears to be a screenshot from a retro-style or pixel-art video game.

> **Figure 4:** A pixelated/low-resolution 3D rendered scene showing a water-level view of a courtyard or outdoor space. There are large terracotta or orange-colored walls on either side, green vegetation, a gray cylindrical structure in the background, and blue water or sky in the foreground. The image has a blocky, voxel-like appearance typical of Minecraft or similar pixel art style graphics.

> **Figure 5:** A low-resolution pixel art style image depicting a simplified 3D landscape scene. The composition shows a blue water body in the foreground, green terrain on the left side, an orange/brown cubic structure in the center, a tall dark tower or building in the background, and a large terracotta or rust-colored cubic form on the right side. The sky is rendered in light blue. The entire scene has a blocky, voxel-based appearance typical of pixel art or early video game graphics.
...
Lpred(ϕ) .
= − ln pϕ(xt | zt, ht) − ln pϕ(rt | zt, ht) − ln pϕ(ct | zt, ht)
Ldyn(ϕ) .
= max 1, KL sg(qϕ(zt | ht, xt)) pϕ(zt | ht) 
Lrep(ϕ) .
= max 1, KL qϕ(zt | ht, xt) sg(pϕ(zt | ht)) (3)
...
st
.
= {ht, zt} and thus benefit from the Markovian representations learned by the recurrent world
model. The actor aims to maximize the return Rt
.
= P∞
τ =0 γτ rt+τ with a discount factor γ = 0.997
...
predicts a distribution, we read out its predicted values vt
.
= E[vψ( · | st)] as the expectation of the
...
size of the targets:
L(θ) .
= − twohot(y)T log softmax(f (x, θ)) (11)
...
IMPALA
Rainbow
PPOFigure 5: Fraction of trained agents that discover each of the three latest items in the Minecraft
...
• DMLab This suite of 30 tasks features 3D environments that test spatial and temporal reason-
...
b
c
dFigure 6: Ablations and robust scaling of Dreamer. a, All individual robustness techniques
...
• Proprio Control This benchmark contains 18 control tasks with continuous actions, proprio-
...
Minecraft video predictionsTrue
Context Input Open Loop Prediction
T = 0
Model
5 10 15 20 25 30 35 40 45 50True
...
environment steps.0 25M 50M 75M 100M
Env steps
0
4
8
...
IMPALA
Rainbow
PPO Figure 8: Minecraft learning curves.0
25
50
75
100
...
Proprioceptive control learning curves0
60
120
180
240
...
Visual control learning curves0
80
160
240
Return
...
BSuite performance spectrumBasic
Credit Assignment
Exploration
Generalization
Memory
...
Learning signal ablations0 20M
0
400K
800K
1.2M
