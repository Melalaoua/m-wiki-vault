...
A [[phd/wiki/concepts/variational-autoencoder|variational-autoencoder]] (VAE) is a probabilistic generative model first introduced by Diederik P. Kingma and Max Welling in 2013. Unlike deterministic autoencoders, VAEs map input data to a continuous [[latent-space]] represented as probability distributions.
