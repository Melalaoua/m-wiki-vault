...
The architecture is composed of six interacting modules: **[[Perception Module|perception]]**, **[[World model|world model]]**, **[[Cost module|cost]]** (itself split into an [[Intrinsic Cost module]] and a [[Trainable Critic module]]), **[[Actor Module|actor]]**, **[[Short-Term Memory Module|short-term memory]]**, and a governing **[[Configurator Module|configurator]]**. Their coordination is meant to support two distinct modes of operation — a fast reactive mode and a slower deliberative mode — echoing Daniel Kahneman's System 1/System 2 distinction.
